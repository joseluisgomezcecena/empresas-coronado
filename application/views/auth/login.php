        ...
        <div class="card shadow-lg">
            <div class="card-body">
                <div class="d-flex align-items-center justify-content-between m-b-30">
                    ...
                    -->
                    <a style="color:black; font-weight:900" class="navbar-brand text-brand" href="<?php echo base_url(); ?>">Empresas<span class="text-primary">Coronado
                        <!--little house icon-->
                        <sup><span class="anticon anticon-car"></sup>
                        </span>
                    </a>
                    <h2 class="m-b-0"></h2>
                </div>
